...
\movedesc{Silent Takedown}{catch an enemy unawares or have an enemy defenseless}{you can just kill them, you don't need to use a weapon. Snap their neck if you have to.}
