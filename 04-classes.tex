...
\paragraph{Yang:} Resolve a tense situation without violence.
...
\begin{itemize} % how others get on with you
...
\end{itemize}
On the others’ turns:
\begin{itemize} % how you get on with others
\item Whatever number they tell you, give it $-1$ and write it next to
...
\movenofail{Mecha Special Ability: Blade Focus}{channel energy into the Lightning Blade}{Cool}
...
\paragraph{Yang:} Go in without a plan.

\subsubsection{Shared History}
Everyone introduces their characters by name, look and outlook. Take
your turn. List the other characters' names. Go around again for
Hx. On your turn:
\begin{itemize} % how open you are
...
\end{itemize}
On the others’ turns:
\begin{itemize} % how interested you are
\item Whatever number they tell you, write it next to their
  character’s name.
\end{itemize}

\movenofail{Inspire}{lead the attack against a foe}{Cool}{2 characters who can see you receive $+1$ forward}{1 character who can see you receives $+1$ forward}

\movenofail{Pep Talk}{attempt to cheer up a dejected comrade}{Talk}{your little chat is mutually beneficial. Both mark 1 experience and get $+1$ forward}{your advice is helpful, but the ordeal takes it out of you. Your friend gets $+1$ forward, but you take $-1$ forward.}
           
\movenofail{Do The Impossible}{start the session}{Cool}{hold 2}{hold 1}
...
\movedesc{Mecha Special Ability: I Said I'm Going To Pilot That Thing!}{deal fatal damage to an enemy mecha}{The GM will offer you a choice: destroy the mecha, or steal the mecha.}

If you choose to steal the mecha, Roll+Cool:
\rollresnofail{you become the new pilot of the target mecha. Any security systems are recalibrated to accept you as the owner, and the mecha is healed for 3-harm}
...
\movenofail{Call For Support}{contact the Agency to request assistance}{Talk}{the Agency agrees to your request, or to do all they can.}{The Agency agrees, but: (choose one)
  \begin{itemize}
  \item It'll take time.
  \item It's not quite what you asked for.
  \item Your audacious request is badly received: $-1$mp at session end.
  \end{itemize}
}

\movenofail{Gadgets}{reveal a mundane item in your possession to be a hidden gadget}{Tech}{it's just what you needed. Treat the mundane item as a Tech Item or single-use knockout weapon.}{it works, but choose one:
  \begin{itemize}
...
\rollresnofail{deal your damage and the subsystem is temporarily disabled.}{the subsystem is temporarily disabled.}
...
\movenofail{An Acquired Taste}{endure an effect or element which falls under your spirit's domain}{Hard}{your spirit protects you and you suffer no ill effects}{the effect or harm is reduced}

\movenofail{It's Elementary}{let your spirit's power flow through you to accomplish a task}{Tech}{choose two:}{choose one:
\begin{itemize}
...
Roll+Tech: \rollresnofail{you gain control of the system, and it gains
  this move.}{the system is disabled.} This ability then needs to
...
\movenofail{Whirlwind Strike}{launch an attack against each enemy in your vicinity}{Fast}{do your damage to each of them and force them back.}{deal your damage to half of them, rounded down}

\movenofail{Focus}{concentrate your energy into your fists}{Hard}{Hold 3}{Hold 1}
...
\move{Best-Laid Plans}{start the session}{Plan}{hold 3}{hold 2}{hold 1, plus whatever the GM says when you spend it}
...
\movenofail{Mission Briefing}{explain your plan to the other players}{Talk, describing up to 3 details.}{the plan is foolproof, and fills your comrades with hope: everyone present takes $+1$ forward now, and again when sticking to the plan.}{the plan is sound: everyone present takes $+1$ when sticking to it.}
...
\rollresnofail{you succesfully destroy the incoming missile}{the missile is shot down, but the Pod is destroyed in the attempt}
