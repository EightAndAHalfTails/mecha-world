...
\item Cool=0 Talk=0 Hard=0 Fast=0 Tech+2 Plan+1
\item Cool-1 Talk-1 Hard+1 Fast+1 Tech+2 Plan+1
\end{itemize}
...
{the solution is clear as day to you, analogous to a common everyday occurrance. (The GM will tell you the solution, it's up to you to technobabble)}
{you reduce the problem to a common analogy, but it's up to you to find the solution (the GM will tell you the analogy. Technobabble about it)}
