...
\begin{dialogue}
  ...
  \speak{LeVallier} Fair enough. 9.

  \speak{GM} Alright, hmm, let's go for an ugly choice. Either the
  ...
  \speak{Levallier} That \emph{is} ugly\ldots
\end{dialogue}

\movenofail{Fast Talk}{make something up on the spot}{Talk}{everyone believes you.}{you raise suspicion, but people go along with you, for now.}
...
\paragraph{Example}
\begin{dialogue}
  \speak{Minori} ``Enough is enough, councillor Hakumoto! All your
  ...
  \speak{GM} Ouch. While I get him some burn cream, roll Taunt, if you
  don't mind.

  \speak{Minori} 13! I'll take the information, no retaliation,
  please.

  \speak{GM} ``Fooools!'' Hakumoto flies into a rage. ``You know
  ...
  \speak{Minori} Damn, we need to get down to the cargo bay right now!
\end{dialogue}

\movenofail{Dash}{try to evade a danger or get somewhere quickly}{Fast}{you're fast enough.}{you make it, but your hesitation costs you. You leave something behind, or end up in a vulnerable spot, GM's choice.}
